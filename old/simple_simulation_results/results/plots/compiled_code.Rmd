---
title: "Compiled Code for All Methods"
author: "Goh Ming Wee"
date: "`r Sys.Date()`"
...
This is an `R` Markdown document. When you click the **Knit** button, a document will be generated in your working directory. It will contain your code, the output of your code, and any text you included in the `Rmd` file within the document.

To answer questions in the tutorial worksheets, add your `R` code in the code blocks under the designated section. You can type texts around the code blocks.

## Methods

### Smooth Elastic Prior
